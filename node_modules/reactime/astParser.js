...
module.exports = elementType => {
  ...
  //? Always in the order that they are declared
  const hookState = {};
  ...
  while (Object.hasOwnProperty.call(ast, 'body')) {
    ...
    ast.forEach(functionDec => {
      //* functionDec is an entire node that is an object: Node {type: "FunctionDeclaration", start: 0, end: 989, id: Node, expression: false, …}
      let body;
