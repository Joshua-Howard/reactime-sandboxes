...
class Tree {
  constructor(component, useStateInstead = false, name) {
    //? When is name defined? If it doesn't have a default value, why is it the third parameter. 
      //* This may be able to be swapped so that it appears to be more intuitive.
    ...
    if (!useStateInstead) {
      ...
      //? What does the setState method do? Why is it automatically invoking a callback. 
      this.component = component === 'root'
        ? { state: 'root', setState: (partial, callback) => callback() }
        : component;
    } else {
      //? When is useStateInstead true to enable us to reach this code?
    ...
    //? When are nodes added to this.children?
      //* One example is the appendChild method below.
  ...
  //? What is the difference between using this method and just console logging tree?
  print() {
